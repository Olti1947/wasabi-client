...
const FoodDetails = ({ id, name, imageUrl, description, price, ingredients }: FoodDetailProps) => {
  ...
  const handleAddToCart = () => {
    ...
    <View style={styles.container}>
        <View style={styles.imageContainer}>
            {imageUrl && <Image style={{width: '100%', height: '100%', borderRadius: 8}} source={{uri: imageUrl}} />
 }
        </View>
