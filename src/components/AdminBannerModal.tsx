...
export function AdminBannerModal({
  ...
  async function submitBanner() {
    ...
    try {
      ...
      await api.post("/api/admin/banner-images", formData, {
        headers: {
  ...
  return (
    <View style={styles.overlay}>
      ...
      <View style={styles.adminModal}>
        ...
        <TouchableOpacity style={styles.adminButton} onPress={submitBanner}>
          <Text style={styles.buttonText}>Submit Banner</Text>
        </TouchableOpacity>
